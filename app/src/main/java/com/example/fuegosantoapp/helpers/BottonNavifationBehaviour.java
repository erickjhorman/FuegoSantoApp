package com.example.fuegosantoapp.helpers;
...
public class BottonNavifationBehaviour extends  CoordinatorLayout.Behavior {
    ...
    public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View child, @NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, @NonNull int[] consumed) {
        ...
        child.setTranslationY(Math.max(0f,
                Math.min(Float.parseFloat(String.valueOf(child.getHeight())),child.getTranslationX() +dxConsumed)));
    }
